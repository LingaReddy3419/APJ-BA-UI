...
const CompareScenariosMap = () => {
  ...
  return (
    <div>
      <MapContainer ref={mapRef} center={defaultPosition} zoom={4} scrollWheelZoom={true} style={{ height: '250px', width: '100%' ,borderRadius:'6px'}}>
        <TileLayer
...
export default CompareScenariosMap;
